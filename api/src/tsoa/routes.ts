...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/my_test',
            ...(fetchMiddlewares<RequestHandler>(MyTestController)),
            ...(fetchMiddlewares<RequestHandler>(MyTestController.prototype.get)),

            function MyTestController_get(request: any, response: any, next: any) {
            const args = {
            };
